...
from createReport import SalesInvoice
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def add_product(self):
        """
        Insert a new row in the table with the data from the product selection, quantity and price fields.
        Then, calculate the total and update the total field in the interface.
        """
